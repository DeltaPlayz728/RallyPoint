...
export default function EventChatPage() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-black flex items-center justify-center text-gray-400">Loading chat...</div>
  )
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-800 bg-gray-950">
        <Link href={`/events/${id}`} className="text-gray-400 hover:text-white">←</Link>
        <div>
