    ...
    <div className="min-h-screen bg-[#fdf6ec] dark:bg-[#15110d] text-[#15110d] dark:text-[#fdf6ec] px-6 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">2. Eligibility</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">3. Your Account</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">4. User Conduct</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">5. Events and Payments</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">6. Content</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">7. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">8. Changes to These Terms</h2>
          ...
          <section>
            <h2 className="text-[#15110d] dark:text-[#fdf6ec] font-semibold text-base mb-2">9. Governing Law</h2>
