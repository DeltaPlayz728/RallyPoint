      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>RallyPoint ("we", "us", "our") is a social experience platform operated by a sole trader registered in the Netherlands. For GDPR purposes, we are the data controller. You can reach us at <a href="mailto:2023ford.john@gmail.com" className="text-orange-400 hover:underline">2023ford.john@gmail.com</a>.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
              <li><strong className="text-gray-300">Account data:</strong> email address, username, date of birth</li>
              <li><strong className="text-gray-300">Profile data:</strong> full name, city, bio, interests, social vibe, profile photo</li>
              <li><strong className="text-gray-300">Social links:</strong> Instagram, TikTok, and Snapchat usernames (if provided)</li>
              <li><strong className="text-gray-300">Event data:</strong> events you create, join, or attend</li>
              <li><strong className="text-gray-300">Messages:</strong> content of group chat messages and meetup requests</li>
              <li><strong className="text-gray-300">Location data:</strong> city/address of events you create (used for map display)</li>
              <li><strong className="text-gray-300">Payment data:</strong> processed by Stripe — we do not store card details</li>
              <li><strong className="text-gray-300">Usage data:</strong> timestamps of activity, notifications read</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">Our legal basis for processing is <strong className="text-gray-300">contract performance</strong> (to provide the service you signed up for) and <strong className="text-gray-300">legitimate interests</strong> (safety, platform improvement). Where required by law, we obtain your consent.</p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-2">4. Social Links Visibility</h2>
            <p>Your social media handles (Instagram, TikTok, Snapchat) are <strong className="text-gray-300">never shown publicly</strong>. They are only visible to users who have attended at least one of the same events as you. This is a core safety feature of RallyPoint.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
              <li><strong className="text-gray-300">Supabase</strong> — our database and authentication provider (EU data residency available)</li>
              <li><strong className="text-gray-300">Stripe</strong> — payment processing. Your payment data is governed by Stripe's privacy policy.</li>
              <li><strong className="text-gray-300">Vercel</strong> — hosting provider</li>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">7. Your Rights (GDPR)</h2>
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-400">
              ...
              <li><strong className="text-gray-300">Rectification</strong> — correct inaccurate data</li>
            ...
            <p className="mt-2">To exercise any of these rights, email us at <a href="mailto:2023ford.john@gmail.com" className="text-orange-400 hover:underline">2023ford.john@gmail.com</a>. We will respond within 30 days. You also have the right to lodge a complaint with the Dutch data protection authority (<a href="https://autoriteitpersoonsgegevens.nl" className="text-orange-400 hover:underline" target="_blank" rel="noopener noreferrer">Autoriteit Persoonsgegevens</a>).</p>
          </section>

          <section>
            <h2 className="text-white font-semibold text-base mb-2">8. Minors</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">9. Cookies</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">10. Security</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">11. Changes to This Policy</h2>
          ...
          <section>
            ...
            <p>For privacy questions or to exercise your rights: <a href="mailto:2023ford.john@gmail.com" className="text-orange-400 hover:underline">2023ford.john@gmail.com</a></p>
          </section>

        </div>

        <div className="mt-12 pt-8 border-t border-gray-800 flex gap-4 text-xs text-gray-600">
          <Link href="/tos" className="hover:text-gray-400 transition">Terms of Service</Link>
