      ...
      >
        ...
        {done ? (
          ...
          <>
            ...
            {targetName && (
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">{targetName}</p>
            )}
              ...
              {REASONS.map(r => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl text-sm border transition ${
                    reason === r
                      ? 'bg-red-100 dark:bg-red-950 border-red-400 text-red-700 dark:text-red-400'
                      : 'bg-white dark:bg-[#221c16] border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:border-gray-400'
                  }`}
                >
                  {r}
                </button>
            ...
            {reason && (
              <textarea
                ...
                rows={2}
                className="w-full bg-white dark:bg-[#221c16] text-[#15110d] dark:text-[#fdf6ec] border border-gray-300 dark:border-gray-700 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500 resize-none mb-4 dark:placeholder-gray-500"
              />
            )}
            ...
            <div className="flex gap-2">
              <button
                onClick={onClose}
                className="flex-1 border border-gray-300 dark:border-gray-700 text-gray-400 py-3 rounded-xl text-sm font-medium hover:border-gray-500 transition"
              >
                Cancel
              </button>
              <button
